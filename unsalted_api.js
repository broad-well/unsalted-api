  ...
  const ModuleManager = {
    ...
    load: function(mod) {
      if (this.validate(mod)) {
        if (this.getByProperty(mod.name) === undefined) {
  ...
  const _mod_utilities = {
    ...
    'check_content_pkg': function(content_pkg_map) {
      if (_mod_utilities.isMap(content_pkg_map)) {
        return 'text' in content_pkg_map &&
        ...
        Object.keys(value).forEach(function(key) {
          if (!_mod_utilities.check_content_pkg(value[key])) {
            if (!(key in packages)) {
              ...
              console.info("Inserted content package element, Key: " + key + ", Value: " + value[key]);
              to_return = true;
            } else {
        ...
        for (var i = 0; i < Object.keys(value).length; i++) {
          ...
          if (!_mod_utilities.type_check(value[Object.keys(value)[i]], 'function')) {
            ...
            if (!(Object.keys(value)[i] in _mod_options_modifiers)) {
              ...
              console.info("Inserted option package element, Key: " + Object.keys(value)[i] + ", Value: " + value[Object.keys(value)[i]]);
            } else {
        ...
        for (var i = 0; i < Object.keys(value).length; i++) {
          ...
          if (!_mod_utilities.type_check(value[Object.keys(value)[i]], 'function')) {
            ...
            if (!(Object.keys(value)[i] in _mod_element_replacers)) {
              ...
              console.info("Inserted manipulator package element, Key: " + Object.keys(value)[i] + ", Value: " + value[Object.keys(value)[i]]);
            } else {
